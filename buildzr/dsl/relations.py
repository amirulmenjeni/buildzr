...
def _is_infrastructure_node_fluent_relationship(
    obj: '_FluentRelationship[Any]',
) -> TypeIs['_FluentRelationship[buildzr.dsl.InfrastructureNode]']:
    return isinstance(obj._parent, buildzr.dsl.InfrastructureNode)
